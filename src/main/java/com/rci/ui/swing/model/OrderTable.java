...
public class OrderTable extends JTable {
	...
	public void setHeaderLabel(){
		...
		cm.getColumn(18).setHeaderValue("美团超级代金券");
		cm.getColumn(18).setPreferredWidth(105);
		cm.getColumn(19).setHeaderValue("POS机");
		cm.getColumn(19).setPreferredWidth(75);
		cm.getColumn(20).setHeaderValue("免单");
		cm.getColumn(20).setPreferredWidth(75);
		cm.getColumn(21).setHeaderValue("总金额");
