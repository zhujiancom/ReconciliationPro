...
public class SchemeCreateWin extends PopWindow implements ActionListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2311845955737104362L;
	...
	public SchemeCreateWin(int width,int height){
		super(width,height);
		createContentPane();
	}
	...
	public VendorCheckListener getCheckListener() {
		return checkListener;
	}

	public void setCheckListener(VendorCheckListener checkListener) {
